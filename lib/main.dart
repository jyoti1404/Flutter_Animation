  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      routes: {
        ...
        'StaggeredAnimationReplication': (_) =>
            new StaggeredAnimationReplication(),
